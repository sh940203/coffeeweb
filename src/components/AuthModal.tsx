                ...
                <div className="p-8">
                    ...
                    <p className="mt-6 text-center text-[10px] text-gray-400">
                        {isLogin ? (
                            <>
                                還沒有帳號？
                                <button onClick={() => { setIsLogin(false); setError(null); }} className="text-gray-900 underline ml-1 hover:text-gray-600">
                                    立即註冊
                                </button>
                            </>
                        ) : (
                            <>
                                已經有帳號？
                                <button onClick={() => { setIsLogin(true); setError(null); }} className="text-gray-900 underline ml-1 hover:text-gray-600">
                                    登入
                                </button>
                            </>
                        )}
